...
def calCenterRect(proj_data, const = 0.1, predict = False):
	if (predict):
...
def calNumPixel(outer, inner, proj_data, m2DX, m2DY, const = 0.25, num_pixel = 1024):
	total = num_pixel**2
	angle = outer[0]
	width = outer[1]
	height = outer[2]
...
# infile = "Quest_20210223_scene(3)_user(1)"
# infile = "Quest_20210315_scene(3)_user(3)"
# infile = "Quest_20210317_scene(3)_user(1)"
# infile = "Quest2_20210323_scene(3)_user(1)"
# infile = "Quest2_20210326_scene(3)_user(2)"
# infile = "Quest_20210326_scene(3)_user(2)"
infile = "Quest_20210326_scene(3)_user(3)"
# infile = "Quest2_20210326_scene(3)_user(3)"
# infile = "Quest_20210412_scene(3)_user(3)_yaw_4900"
# infile = "Quest_20210412_scene(3)_user(3)_pitch"
...
# Variables
# TRAINED_MODEL_NAME = './Quest_realtime_model_20210223'
# TRAINED_MODEL_NAME = './Quest_realtime_model_20210315'
# TRAINED_MODEL_NAME = './Quest_realtime_model_20210317'
# TRAINED_MODEL_NAME = './Quest2_realtime_model_20210323'
# TRAINED_MODEL_NAME = './Quest2_realtime_model_20210326'
# TRAINED_MODEL_NAME = './Quest_realtime_model_20210326'
TRAINED_MODEL_NAME = './Quest_realtime_model_20210326_3'
# TRAINED_MODEL_NAME = './Quest2_realtime_model_20210326_3'
# TRAINED_MODEL_NAME = './Quest_realtime_model_20210412_yaw'
# TRAINED_MODEL_NAME = './Quest_realtime_model_20210412_pitch'
...
""""""""" Old Preprocessong """""""""
# Save it
# scaler_file = "Quest_realtime_scaller_20210223.save"
# scaler_file = "Quest_realtime_scaller_20210315.save"
# scaler_file = "Quest_realtime_scaller_20210317.save"
# scaler_file = "Quest2_realtime_scaller_20210323.save"
# scaler_file = "Quest2_realtime_scaller_20210326.save"
# scaler_file = "Quest_realtime_scaller_20210326.save"
scaler_file = "Quest_realtime_scaller_20210326_3.save"
# scaler_file = "Quest2_realtime_scaller_20210326_3.save"
# scaler_file = "Quest_realtime_scaller_20210412_yaw.save"
# scaler_file = "Quest_realtime_scaller_20210412_pitch.save"
...
patternX = radiiPattern[:,0:3]
patternY = radiiPattern[:,3::]
ellipsAmount = np.pi*patternX*patternY
...
plt.figure()
plt.plot(timestamp_plot[:len(highRes)], highRes, color = "blue")
